...
function m:draw(scene)
    ...
    if self.s.log[self.s.log.first] then
      local cmd = self.s.log[self.s.log.first]
      love.graphics.print(
      string.format("%03.f (%s)", self.s.heading, cmd['name'] or string.format("%03d", cmd['heading'] or self.s.set_heading)),
      p.x + 5, p.y + 17)
      ...
      love.graphics.print(
      string.format("%03.f (%03.f)", self.s.heading, self.s.set_heading),
      p.x + 5, p.y + 17)
    end
    ...
    p.x + 5, p.y + 41)
		...
		love.graphics.print("HDG", p.x-25, p.y+17)
		love.graphics.print("SPD", p.x-25, p.y+29)
		love.graphics.print("ALT", p.x-25, p.y+41)
